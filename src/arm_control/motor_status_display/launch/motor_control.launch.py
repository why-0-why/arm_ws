...
def generate_launch_description():
    ...
    controller3_name = launch.actions.DeclareLaunchArgument('controller3_name', default_value='C3')
    ...
    controller3_node_id = launch.actions.DeclareLaunchArgument('controller3_node_id', default_value='3')
    ...
    action_node_controller2 = launch_ros.actions.Node(
        ...
        output='screen',
        parameters=[{'controller_node_id': launch.substitutions.LaunchConfiguration('controller2_node_id'),
                     'reduction_ratio': launch.substitutions.LaunchConfiguration('M3508_reduction_ratio'), 
                     'encode_num': launch.substitutions.LaunchConfiguration('M3508_encode_num'), 
                     'controled_node_id': launch.substitutions.LaunchConfiguration('joint2_node_id')}]
    )
    action_node_controller3 = launch_ros.actions.Node(
        package='angle_read',
        executable='angle_read_node',
        name=[launch.substitutions.LaunchConfiguration('controller3_name')],
        output='screen',
        parameters=[{'controller_node_id': launch.substitutions.LaunchConfiguration('controller3_node_id'),
                     'reduction_ratio': launch.substitutions.LaunchConfiguration('M2006_reduction_ratio'), 
                     'encode_num': launch.substitutions.LaunchConfiguration('M2006_encode_num'), 
                     'controled_node_id': launch.substitutions.LaunchConfiguration('joint3_node_id')}]
    )
    ...
    action_node_joint1 = launch_ros.actions.Node(
        ...
        output='log',
        parameters=[{'node_id': launch.substitutions.LaunchConfiguration('joint1_node_id'),
                     'mode': launch.substitutions.LaunchConfiguration('position_mode')}]
    )
    action_node_joint2 = launch_ros.actions.Node(
        ...
        output='log',
        parameters=[{'node_id': launch.substitutions.LaunchConfiguration('joint2_node_id'),
                     'mode': launch.substitutions.LaunchConfiguration('position_mode')}]
    )
    action_node_joint3 = launch_ros.actions.Node(
        package='servo_motor_control',
        executable='servo_motor_node',
        name=[launch.substitutions.LaunchConfiguration('joint3_name')],
        output='log',
        parameters=[{'node_id': launch.substitutions.LaunchConfiguration('joint3_node_id'),
                     'mode': launch.substitutions.LaunchConfiguration('position_mode')}]
    )
    ...
    action_node_motor_status_display1 = launch_ros.actions.Node(
        ...
        output='screen',
        parameters=[{'node_id': launch.substitutions.LaunchConfiguration('joint1_node_id'),
                     'controller_node_id': launch.substitutions.LaunchConfiguration('controller1_node_id')}]
    )
    action_node_motor_status_display2 = launch_ros.actions.Node(
        ...
        output='screen',
        parameters=[{'node_id': launch.substitutions.LaunchConfiguration('joint2_node_id'),
                     'controller_node_id': launch.substitutions.LaunchConfiguration('controller2_node_id')}]
    )
    action_node_motor_status_display3 = launch_ros.actions.Node(
        package='motor_status_display',
        executable='motor_status_display_node',
        output='screen',
        parameters=[{'node_id': launch.substitutions.LaunchConfiguration('joint3_node_id'),
                     'controller_node_id': launch.substitutions.LaunchConfiguration('controller3_node_id')}]
    )
    # 3.合成启动描述并返回
